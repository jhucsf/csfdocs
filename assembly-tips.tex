...
You are free to modify, redistribute and use this document in any way provided that you:

\begin{enumerate}
    \item Distribute a copy of the LaTeX source with each rendered document.
    \item Attribute the authors of the original work in any derived work and clearly indicate
    that it is a derived work.
    \item Retain a copy of this Notice in all derived works.
\end{enumerate}

Additionally, we ask that you notify the course staff if you make any notable
modifications, or notice any areas of improvement for this document.
\newpage
